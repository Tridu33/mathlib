...
(measurable_spanning_sets : ∀ i, is_measurable (spanning_sets i))
...
⟨λ _, s, λ _, hs, λ _, measure_lt_top, Union_const _⟩
...
begin
  ...
  refine ext_finite C hA hC (μ.restrict (B i)) (ν.restrict (B i)) _ _,
